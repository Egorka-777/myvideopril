...
namespace VideoBatch {
    ...
    public class MainWindow:Form {
        ...
        public MainWindow(){Text="VideoBatch 4.0.2";ClientSize=new Size(800,650);MinimumSize=new Size(760,640);StartPosition=FormStartPosition.CenterScreen;Font=new Font("Segoe UI",10);BackColor=Ui.Bg;ForeColor=Ui.Ink;AutoScaleMode=AutoScaleMode.Dpi;
            if(!ToolsLocator.TryResolve(out ffmpeg,out ffprobe,out _)){ffmpeg="";ffprobe="";}
            ...
            Shown+=(s,e)=>{if(!ToolsLocator.TryResolve(out ffmpeg,out ffprobe,out var hint))status.Text=hint.Replace("\n"," ");};
        }
        ...
        void Tools(){if(!ToolsLocator.TryResolve(out ffmpeg,out ffprobe,out var hint))throw new Exception(hint);}
